...
public class StudentSteps {
    ...
    @Step("Getting the student information with lastName: {0}")
    public HashMap<String, Object> getStudentInfoByFirstname(String lastName) {
        String p1 = "findAll{it.lastName=='";
        String p2 = "'}.get(1)";
        return SerenityRest.given().log().all()
                .when()
